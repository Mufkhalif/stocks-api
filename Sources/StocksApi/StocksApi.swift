...
public struct StocksApi: IStocksApi {
    ...
    private func urlForChartData(symbol: String, range: ChartRange) -> URL? {
        ...
        urlComp.queryItems = [
            ...
            URLQueryItem(name: "intrval", value: range.interval),
    ...
    // MARK: Fetcher with Tuple of typeData with statusCode
    ...
    // MARK: Validate http statusCode response
